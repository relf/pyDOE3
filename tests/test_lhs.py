...
class TestLhs(unittest.TestCase):
    ...
    #
    def arrayEqual (self, actual, expected):
    ...
    #
    def test_lhs1(self):
        expected = [[ 0.12484671,  0.95539205,  0.24399798],
                    [ 0.53288616,  0.38533955,  0.86703834],
                    [ 0.68602787,  0.31690477,  0.38533151]]
        actual = lhs(3, random_state=42)
        self.arrayEqual(actual, expected)

    def test_lhs2(self):
        expected = [[ 0.06242335,  0.19266575,  0.88202411,  0.89439364],
    ...
    def test_lhs4(self):
        expected = [[0.69754389, 0.2997106 , 0.96250964],
    ...
    def test_lhs5(self):
        ...
        expected = [[0.4846803, 0.74226839, 0.23305339, 0.97000772], 
        ...
        actual = lhs(4, samples=5, criterion='correlation', iterations=10, random_state=42)
        self.arrayEqual(actual, expected)
